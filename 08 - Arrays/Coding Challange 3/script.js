...
new property. Do NOT create a new array, simply loop over the array. Forumla: recommendedFood = weight ** 0.75 * 28. 
...
// 4
console.log(`${ownersEatTooMuch.join(' and ')} dogs eats to much`);
console.log(`${ownersEatTooLittle.join(' and ')} dogs eats to little`);
