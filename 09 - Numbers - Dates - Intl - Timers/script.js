...
// max - min value
console.log(Math.max(2, 3, 5, 56, 7, 8));
console.log(Math.min(2, 3, 5, 56, 7, 8));
...
// big int number
console.log(1231235659045838749573021234812n);
