...
A poll has a question, an array of options from which people can choose,
 and an array with the number of replies for each option. This data 
...
default option. If type is 'string', display a string like 
...
BONUS: Use the 'displayResults' method to display the 2 arrays in 
the test data. Use both the 'array' and the 'string' option. 
...
// para testear uso call para que tome el objeto que le paso en vez
// de "this".
